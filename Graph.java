...
public class Graph {
	...
	public Graph(List<Vertex> vertexList, Map<Vertex, 
			List<Edge>> ver_edgeList_map) {
		super();
	...
	public void setVer_edgeList_map(
	...
	static class Vertex {
		...
		public boolean equals(Object obj) {
			if (!(obj instanceof Vertex)) {
				throw new ClassCastException("an object to compare "
						+ "with a Vertext must be Vertex");
			}

			if (this.name == null) {
				throw new NullPointerException("name of Vertex to "
						+ "be compared cannot be null");
			}
	...
	public void updateChildren(Vertex v) {
		...
		for (Edge e : ver_edgeList_map.get(v)) {
			...
			if (!childVertex.isKnown()) {
				...
				childVertex.setAdjuDist(v.getAdjuDist() 
						+ e.getWeight());
